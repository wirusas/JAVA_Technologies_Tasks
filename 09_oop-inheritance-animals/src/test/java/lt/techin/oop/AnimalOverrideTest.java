...
public class AnimalOverrideTest {
    ...
    public void classDogExists() {
        Assertions.assertDoesNotThrow(() -> Class.forName("lt.techin.oop.Dog"), "Class Dog does not exist");
    }
    ...
    public void classBirdExists() {
        Assertions.assertDoesNotThrow(() -> Class.forName("lt.techin.oop.Bird"), "Class Bird does not exist");
    }
